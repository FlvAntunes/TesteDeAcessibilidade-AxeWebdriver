...
Cenário: 2- Verificar se a acessibilidade da pagina de transferencia com padrão WCAG 2.1
Quando ele acessar a funcionalidade de transferencia
Entao verifico o padrão de acessibilidade wcag21aa

Cenário: 3- Verificar se a acessibilidade da pagina de confirmação de transferencia com todas as diretrizes
Quando ele acessar a funcionalidade de transferencia
E preencher o valor "333.2"
E confirmar a transferencia
Então deve ser exibido a mensagem "You successfully submitted your transaction."
